package cn.luis.coca.base.enums;
...
@Getter
@AllArgsConstructor
public enum AliErrorCodeDescEnum implements CodeDescEnumAble {

    /**
     * 成功
     */
    SUCCESS(ErrorMessage.success().getCode(), ErrorMessage.success().getDesc()),
    /**
     * 一级宏观错误码
     */
     ...
     * 二级宏观错误
     */
    SYSTEM_ERROR_B0400("B0400", "异步反馈异常"),
    SYSTEM_ERROR_B0401("B0401", "未查询到对应反馈状态"),
    SYSTEM_ERROR_B0402("B0402", "异步反馈尚未完成"),
    SYSTEM_ERROR_B0403("B0403", "异步反馈失败"),

    /**
     * 二级宏观错误
     */
    SYSTEM_ERROR_B0500("B0500", "SQL异常"),
